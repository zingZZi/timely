    ...
    <>
      ...
      <S.UpdateFeedWrap>
        <S.UpdateFeed>
          ...
          <S.Filters>
            <button>전체</button>
            <button><TrendingUp/>진행사항</button>
            <button><Flag/>마일스톤</button>
            <button><Info/>리스크</button>
          ...
          <S.MilestoneLists>
            <S.MilestoneList>
              ...
              <div>
                ...
                <S.MileStoneDescription>디자인 작업이 완료되었습니다. 모든 화면의 UI가 완성되어 개발팀에 전달되었습니다.</S.MileStoneDescription>
              </div>
            </S.MilestoneList>
