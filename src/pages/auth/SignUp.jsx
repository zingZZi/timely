...
function SignUp() {
  ...
  const validators = {
    ...
    passwordConfirm: (value, form) => value === form.password,
  };
  ...
  useEffect(() => {
    setAuthText(
      <>
        <h3>
          팀과 함께 <span>성장하세요</span>
        </h3>
        <p>
          Timely에 가입하고 효율적인 협업을 시작하세요. 팀원들과 함께 목표를
          달성하고 성과를 만들어갑니다.
        </p>
        <ul>
          <li>
  ...
  return (
    <>
      ...
      <S.AuthLink>
        이미 계정이 있으신가요?{" "}
        <S.StyledLink to="/auth/signin">로그인하기</S.StyledLink>
      </S.AuthLink>
      <form onSubmit={DataSubmit}>
        ...
        <fieldset>
          ...
          <FormField
            ...
            id="password"
            error={pwValid}
            errorText="비밀번호는 영문, 숫자, 특수문자를 포함한 8자 이상이어야 합니다."
          >
            <Input
              value={form.password}
              type="password"
